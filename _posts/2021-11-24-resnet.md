...
Table below presents a summerised description of the Resnet convnet architecture per each of the 5 networks presented in the Resnet paper. The table is copied from the Resnet paper almost as is.
