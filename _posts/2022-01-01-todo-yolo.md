...
The Post Processing block selects the final detections amongst all detection candidates it receives.

The input consists of all detection records YOLOv3 CNN generates, i.e. 13x13x3 detection records generated by coarse scale, 26x26x3 and 52x52x3 records generated by medium and fine scale CNN paths respectively.
...
So the total number of detection descriptors candidates is 10647. The structure of each detection descriptor is illustrated (again) by the diagram below:
